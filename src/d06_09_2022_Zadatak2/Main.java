...
public class Main {
	...
	public static void main(String[] args) {
		PlaninarskiDom x = new PlaninarskiDom();
		x.setGodOsnivanja(2000);
		x.setNaziv("Laza Lazarevic");
		RekreativniPlaninar x1 = new RekreativniPlaninar(13,"zoki Peric",10,"Jablanicki",2000);
		RekreativniPlaninar x2 = new RekreativniPlaninar(14,"Pera Peric",9,"Nisavski",2000);
		RekreativniPlaninar x3 = new RekreativniPlaninar(15,"laki Peric",5,"Beogradski",2000);
		
		Alpinista c1 = new Alpinista(1, "Nikola Nikolic", 10);
		Alpinista c2 = new Alpinista(2, "Pedja Nikolic", 11);
		Alpinista c3 = new Alpinista(3, "Milan Nikolic", 12);
		...
		x.dodajPlaninara(c2);
		x.dodajPlaninara(c3);
		x.izbaciPlaninara(14);
		
		x.stampajDom();
		System.out.println(x.ukupnaClanarina());
		for (int i = 0; i < x.getPlaninari().size(); i++) {
			System.out.println(x.getPlaninari().get(i).clanarina());
		}
